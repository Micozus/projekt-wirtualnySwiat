...
public class Trawa extends Roslina {
    ...
    public Trawa(Lokalizacja polozenie, Swiat jakiSwiat, int wiek, int sila, int reproductionCooldown, boolean czyCiaza) {
        this.swiat = jakiSwiat;
        this.polozenie = polozenie;
        this.wiek = wiek;
        this.sila = sila;
    ...
    public boolean equals(Object o) {
        ...
        Trawa trawa = (Trawa) o;
        return sila == trawa.sila &&
                wiek == trawa.wiek &&
                Objects.equals(typeName, trawa.typeName) &&
                Objects.equals(polozenie, trawa.polozenie);
    }

    @Override
    public int hashCode() {
        return Objects.hash(typeName, polozenie, sila, wiek);
    }
}
